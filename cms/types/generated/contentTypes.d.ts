...
export interface ApiAnnouncementBarAnnouncementBar extends Struct.SingleTypeSchema {
  collectionName: 'announcement_bars';
  info: {
    description: 'Messages rotating in the bar above the header';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    messages: Schema.Attribute.Component<'shared.announcement', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiBadgeBadge extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product label such as Sale, New or Bestseller';
    displayName: 'Badge';
    pluralName: 'badges';
    singularName: 'badge';
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product category shown as a tab above the products';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product card shown in the How it works section';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    discountPercent: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    discountType: Schema.Attribute.Enumeration<['none', 'percentage', 'salePrice']> &
      Schema.Attribute.Required &
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    variantGroups: Schema.Attribute.Component<'product.variant-group', true>;
  };
}
